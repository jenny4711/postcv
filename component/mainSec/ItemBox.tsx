...
export default function ItemBox({item,index}:{item:any,index:number}) {
  return (
    ...
    <div key={index} className=" mr-[35px] flex flex-row   gap-3   w-[430px] sm:w-[602px] justify-center  border border-gray-100  hover:bg-gray-50">
      <div className="flex flex-row mr-[2px]  gap-3  pt-[22px] pb-[16px] px-[20px]  w-[382px] sm:w-[554px] ">
    ...
    <div className="flex flex-col flex-grow leading-[16px]">
      ...
      <p className="pt-[4px] leading-[22px] text-[14px] tracking-[0.022rem] text-gray-500 w-[322px] sm:w-[433px]  ">{item?.content}</p>
      {item?.image && (
